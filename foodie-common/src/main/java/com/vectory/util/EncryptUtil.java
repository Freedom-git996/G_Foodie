...
public class EncryptUtil {
     ...
     * @return String
     */
    public String messageDigest(String res,String algorithm){
        try {
     ...
     * @return String
     */
    public String keyGeneratorMac(String res,String algorithm,String key){
        try {
            SecretKey sk = null;
            if (key==null) {
